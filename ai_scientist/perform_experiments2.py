...
# in do_idea() from launch_scientist.py
coder = Coder.create(
...
coder_prompt = """Your goal is to write the code based on the following idea: {title}.
...
def perform_experiments(idea, folder_name, coder, baseline_results) -> bool:
    ...
    current_iter = 0
    run = 1
    # fill in the prompt with the experiment idea and baseline results
